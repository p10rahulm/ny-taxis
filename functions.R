...
train[(train$pickup_longitude < -74.000780 & train$pickup_longitude >= -74.24602) & (train$pickup_latitude < 40.988000 & train$pickup_latitude >= 40.87492),"map_buckets" ] <- 1

# -----------------
# # Bucket 2
# -----------------

train[(train$pickup_longitude < -74.000780 & train$pickup_longitude >= -74.24602) & (train$pickup_latitude < 40.847492 & train$pickup_latitude >= 40.700768),"map_buckets" ] <- 2

# -----------------
# # Bucket 3
# -----------------

train[(train$pickup_longitude < -74.000780 & train$pickup_longitude >= -74.24602) & (train$pickup_latitude < 40.700780 & train$pickup_latitude >= 40.41323),"map_buckets" ] <- 3

# -----------------
# # Bucket 4
# -----------------

train[(train$pickup_longitude < -73.915957 & train$pickup_longitude >= -74.00780) & (train$pickup_latitude < 40.700780 & train$pickup_latitude >= 40.41323),"map_buckets" ] <- 4
...
train[(train$pickup_longitude < -73.49034 & train$pickup_longitude >= -73.915957) & (train$pickup_latitude < 40.801191 & train$pickup_latitude >= 40.700780),"map_buckets" ] <- 6

# -----------------
# # Bucket 7
# -----------------

train[(train$pickup_longitude < -73.49034 & train$pickup_longitude >= -73.915957) & (train$pickup_latitude < 40.988000 & train$pickup_latitude >= 40.801191),"map_buckets" ] <- 7

# -----------------
# # Bucket 8
# -----------------

train[(train$pickup_longitude < -73.915957 & train$pickup_longitude >= -74.00780) & (train$pickup_latitude < 40.98800 & train$pickup_latitude >= 40.801191),"map_buckets" ] <- 8
