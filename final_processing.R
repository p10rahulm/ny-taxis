...
# ---------------------------
# getpickup_map_buckets_lat+long for buckets 1-8
# ---------------------------
...
# ---------------------------
# getdropoff_map_buckets_lat+long for buckets 1-8 - Drop off
# ---------------------------
...
# ---------------------------
# Get subbuckets for new jersey and brooklyn - Dropoff
# ---------------------------
...
# ---------------------------
# Removing unnecessary points - Dropoff
# ---------------------------
